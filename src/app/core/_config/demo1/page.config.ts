export class PageConfig {
	public defaults: any = {
		...
		'sub-admin': {
			...
			'subadmin-add': {page: {title: 'Add Sub-Admin', desc: ''}},
			'subadmin-edit': {page: {title: 'Edit Sub-Admin', desc: ''}},
			'subadmin-view': {page: {title: 'View Sub-Admin', desc: ''}}
			
		},
		'admins': {

			'admins-add': {page: {title: 'Add Admins', desc: ''}},
			'admins-edit': {page: {title: 'Edit Admins', desc: ''}},
			'admins-view': {page: {title: 'View Admins', desc: ''}}
