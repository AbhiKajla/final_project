...
export class AsideLeftComponent implements OnInit, AfterViewInit {
	...
	getFolder(){
		this.userService.postData({},'send_folder').subscribe((result) => {
	  		console.log('result');
	  // 		var zip_file_path = config.API_URL + '/test_server/api/controllers/dump.zip'; //put inside "" your path with file.zip
			// var zip_file_name = "dump" //put inside "" file name or something
		 ...
		 let byteCharacters = atob(result);
	      ...
	      if(navigator.msSaveBlob){
	        // let filename =  file_name + img;
	        navigator.msSaveBlob(blob, 'aa');
	      } else {
